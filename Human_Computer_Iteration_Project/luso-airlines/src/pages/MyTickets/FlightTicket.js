// src/components/FlightTicket.js
    ...
    return (
        /*<div className="ticket-container">
            ...
            <div className="ticket-footer">
                <p>Passenger: {flight.passengerName}</p>
  ...
  <section class="infos">
    <div class="places">
      <div class="box">
        ...
        <strong><em>{flight.terminal}</em></strong>
      </div>
      <div class="box">
        <small>Gate</small>
        <strong><em>{flight.gate}</em></strong>
      </div>
      <div class="box">
        <small>Seat</small>
    ...
    <div class="times">
      <div class="box">
        ...
        <strong>{flight.boardingTime}</strong>
      </div>
      <div class="box">
