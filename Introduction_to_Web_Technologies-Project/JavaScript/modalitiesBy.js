...
function buildList(modalities="a") {
    let table2 = document.getElementById('data2')
    table2.innerHTML = ""

    let url = `http://192.168.160.58/Olympics/api/Modalities/SearchByName?q=${modalities}`
    ...
    fetch(url)
        ...
        let counter = 0
           for (const modal of data) {
            ...
            <td class="text-end">
                <a class="btn btn-default btn-light btn-xs" href="./modalitiesDetails.html?id=${id}">
